    ...
    return (
        <>
            <div className="flex justify-center">
                <Menubar className="shadow-lg w-fit">
                    <MenubarMenu>
                        ...
                        <MenubarContent>
                            <MenubarItem>
                                <div className="flex ">
                                    ...
                                    <a target="_blank" href="https://www.linkedin.com/in/maximo-figuera-531231323/" className="ml-2">Linkedin</a>
                                </div>
                            ...
                            <MenubarItem>
                                <div className="flex ">
                                    ...
                                    <a target="_blank" href="https://www.instagram.com/z3maxi/" className="ml-2">Instagram</a>
                                </div>
                            </MenubarItem>
                            <MenubarSeparator />
                            <MenubarItem>
                                ...
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-mail"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z" /><path d="M3 7l9 6l9 -6" /></svg>
                                    <a target="_blank" href="" className="ml-2">Gmail</a>
                                </div>
                            </MenubarItem>
                        </MenubarContent>
                    </MenubarMenu>
